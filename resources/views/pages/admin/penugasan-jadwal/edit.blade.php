...
invalid @enderror" value="{{ old('nama_jadwal', $jadwalKerja-
...
invalid @enderror" value="{{ old('kode_jadwal', $jadwalKerja-
...
invalid @enderror" value="{{ old('jam_masuk', $jadwalKerja-
...
invalid @enderror" value="{{ old('jam_pulang', $jadwalKerja-
...
@enderror" value="{{ old('toleransi_terlambat_menit', $jadwalKerja-
>toleransi_terlambat_menit) }}" required>
